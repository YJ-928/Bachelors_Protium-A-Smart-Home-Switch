...
class sub_mqtt():
    ...
    def callback_on_message(self, client, userdata, message):
        ...
        print(f"[mqtt] sub_topic: {self.sub_topic}")
        print(f"[mqtt] message: {message.payload.decode()}")

        if (self.sub_topic == 'protium/led1/switchStatus'):
            json['led1'] = message.payload.decode()
        elif (self.sub_topic == 'protium/led2/switchStatus'):
            json['led2'] = message.payload.decode()
        elif (self.sub_topic == 'protium/fan/switchStatus'):
            json['fan'] = message.payload.decode()
        elif (self.sub_topic == 'protium/plug/switchStatus'):
